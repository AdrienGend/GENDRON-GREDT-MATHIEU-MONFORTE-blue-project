...
const event3 = new Events(3,"Le Mariage Royal", "Un mariage royal est prévu dans le royaume.", "Le Chevalier organise un somptueux mariage", "Le Bouffon anime la fête avec humour",() => {player.changeGold(-15),player.changePopulation(10)},() => {player.changeGold(-7),player.changePopulation(15)} , "chevalier");
const event4 = new Events(4,"La Quête du Graal", "Le Graal est recherché pour apporter la gloire au royaume.", "Le Chevalier part à la recherche du Graal", "Le Conseiller investit dans la recherche du Graal",() => {player.changeGold(-5),player.changeFaith(15)},() => {player.changeGold(-15),player.changePopulation(10)} , "chevalier");
