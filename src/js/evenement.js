...
const event1 = new Events(false,"L'Epidémie Mortelle", "Une épidémie mortelle sévit dans le village.", "Le Pape bénit le village pour guérir la maladie", "Le Conseiller organise une quarantaine stricte",() => {player.changeFaith(10),player.changePopulation(-5)},() => {player.changeArmy(10),player.changePopulation(-5)} , "pape");
...
const event5 = new Events(false,"La Peste Noire", "La peste noire menace le royaume.", "Le Pape organise des processions religieuses pour lutter contre la peste", "Le Mage concocte un remède coûteux",() => {player.changeFaith(15),player.changePopulation(-15)},() => {player.changeGold(-15),player.changePopulation(10)} , "pape");
...
const event8 = new Events(false,"La Famine", "Le royaume souffre de la famine.", "Le Chasseur fournit de la viande pour nourrir le peuple affamé", "Le Capitaine des soldats réquisitionne les réserves pour l'armée",() => {player.changeArmy(-10),player.changePopulation(15)},() => {player.changePopulation(-10),player.changeArmy(15)} , "archer");
