...
const event9 = new Events(9,"La Famine", "Le royaume souffre de la famine.", "Le Chasseur fournit de la viande pour nourrir le peuple affamé", "Le Capitaine des soldats réquisitionne les réserves pour l'armée",() => {player.changeGold(-30),player.changePopulation(20)},() => {player.changeGold(-20),player.changeArmy(20)} , "archer");
