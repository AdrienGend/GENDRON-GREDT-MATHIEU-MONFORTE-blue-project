...
const event1 = new Events(1,"L'Epidémie Mortelle", "Une épidémie mortelle sévit dans le village.", "Le Pape bénit le village pour guérir la maladie", "Le Conseiller organise une quarantaine stricte",() => {player.changeFaith(10),player.changePopulation(-5)},() => {player.changeArmy(10),player.changePopulation(-5)} , "pape");
const event2 = new Events(2,"La Révolte des Paysans", "Les paysans se révoltent contre les conditions de vie difficiles.", "Le Capitaine des soldats réprime violemment la révolte", "Le Mage utilise des sorts pour calmer les paysans",() => {player.changeArmy(10),player.changePopulation(-10)},() => {player.changeFaith(10),player.changePopulation(-5)} , "capitaine");
const event3 = new Events(3,"Le Mariage Royal", "Un mariage royal est prévu dans le royaume.", "Le Chevalier organise un somptueux mariage", "Le Bouffon anime la fête avec humour",() => {player.changeGold(-15),player.changePopulation(10)},() => {player.changeGold(-7),player.changePopulation(15)} , "bouffon");
const event4 = new Events(4,"La Quête du Graal", "Le Graal est recherché pour apporter la gloire au royaume.", "Le Chevalier part à la recherche du Graal", "Le Conseiller investit dans la recherche du Graal",() => {player.changeGold(10),player.changeArmy(-5)},() => {player.changeGold(-15),player.changePopulation(10)} , "chevalier");
const event5 = new Events(5,"La Peste Noire", "La peste noire menace le royaume.", "Le Pape organise des processions religieuses pour lutter contre la peste", "Le Mage concocte un remède coûteux",() => {player.changeFaith(15),player.changePopulation(-15)},() => {player.changeGold(-15),player.changePopulation(10)} , "pape");
const event6 = new Events(6,"La Révolte des Soldats", "Les soldats se révoltent pour de meilleures conditions.", "Le Capitaine des soldats apaise les soldats en leur offrant des primes", "Le Conseiller négocie avec les soldats pour éviter la révolte",() => {player.changeGold(-15),player.changeArmy(10)},() => {player.changeGold(-10),player.changePopulation(5)} , "conseiller");
const event7 = new Events(7,"L'Invasion Barbare", "Le royaume est menacé par une invasion barbare.", "Le Capitaine des soldats mobilise l'armée pour défendre le royaume", "Le Marchand vend des armes aux envahisseurs en échange de trésors",() => {player.changeArmy(5),player.changeGold(-10)},() => {player.changeGold(10),player.changeArmy(-5)} , "capitaine");
const event8 = new Events(8,"La Quête du Saint Graal (suite)", "La quête du Saint Graal continue.", "Le Chevalier trouve le Graal et apporte la gloire au royaume", "Le Mage échoue dans sa quête, ce qui attriste le peuple",() => {player.changeFaith(-10),player.changePopulation(10)},() => {player.changePopulation(-10),player.changeFaith(10)} , "chevalier");
const event9 = new Events(9,"La Famine", "Le royaume souffre de la famine.", "Le Chasseur fournit de la viande pour nourrir le peuple affamé", "Le Capitaine des soldats réquisitionne les réserves pour l'armée",() => {player.changeGold(-10),player.changePopulation(15)},() => {player.changeGold(-5),player.changeArmy(15)} , "archer");
const event10 = new Events(10,"Le Schisme Religieux", "Le royaume est en proie à un schisme religieux.", "Le Pape travaille à réconcilier les factions religieuses", "Le Mage profite du schisme pour gagner en influence",() => {player.changePopulation(10),player.changeFaith(-10)},() => {player.changePopulation(-10),player.changeFaith(10)} , "pape");
const event11 = new Events(11,"La Guerre avec le Royaume Voisin", "Le royaume est en guerre avec un royaume voisin.", "Le Capitaine des soldats prépare l'armée à la guerre", "Le Marchand vend des fournitures aux deux côtés",() => {player.changeArmy(10),player.changeGold(-10)},() => {player.changeGold(10),player.changeArmy(-5)} , "capitaine");
