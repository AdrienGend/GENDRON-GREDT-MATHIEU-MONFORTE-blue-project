...
const event7 = new Events(7,"L'Invasion Barbare", "Le royaume est menacé par une invasion barbare.", "Le Capitaine des soldats mobilise l'armée pour défendre le royaume", "Le Marchand vend des armes défectueuses aux envahisseurs en échange de trésors",() => {player.changeArmy(5),player.changeGold(-10)},() => {player.changeGold(10),player.changeArmy(-5)} , "capitaine");
const event9 = new Events(9,"La Famine", "Le royaume souffre de la famine.", "Le Chasseur fournit de la viande pour nourrir le peuple affamé", "Le Capitaine des soldats réquisitionne les réserves pour l'armée",() => {player.changeArmy(-10),player.changePopulation(15)},() => {player.changePopulation(-10),player.changeArmy(15)} , "archer");
